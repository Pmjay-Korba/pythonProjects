...
class AllListGenerator:
    ...
    def retrieve_date_new_claim_query(self, page: Page, case_number):
        ...
        date = date + "a"  # to convert to string
        ...
        return card, name, case_number, date, depart, procedure, status, current_status, amount
            ...
            if not is_query_question_required:
                ...
                try:
                    try:# clicking SHOW MORE
                        page.wait_for_selector("//*[name()='circle' and @id='bg-icon']/ancestor::something/parent::div/parent::div/parent::div/div[2]/div[last()]/div[2]/div[3]//span[contains(text(),'...Show More')]").click()
                    ...
                    question = page.wait_for_selector("(//div[contains(@class,'react-draggable')]//strong)[last()]").text_content()
                    # print(question)
                    # close button
